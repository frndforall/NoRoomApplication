package com.sodhan.noroomapplication.db;
...
import com.sodhan.noroomapplication.db.entity.Contact;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Contact getContact(long Id) {
        ...
        }, Contact.COLUMN_ID + "=?", new String[]{String.valueOf(Id)}, null, null, null, null);
    ...
    public int updateContact(Contact contact) {
        ...
        int id= db.update(Contact.TABLE_NAME, values,Contact.COLUMN_ID + "=?", new String[]{String.valueOf(contact.getId())});
        db.close();
        return id;
    }
